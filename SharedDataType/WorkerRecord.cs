...
namespace WorkerRecord
{
    ...
    public class SingleWageRecord
    {
        ...
        {
            get => _Daily_wages;
            private set { _Daily_wages = value; }
        }
        ...
        {
            get => _Sunday_wages;
            private set { _Sunday_wages = value; }
        }
        ...
        {
            get => _Monthly_wages;
            private set { _Monthly_wages = value; }
        }
        ...
        {
            get => _Hourly_wages;
            private set { _Hourly_wages = value; }
        }
